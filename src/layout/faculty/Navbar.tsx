      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div className="min-w-0">
          <div className="flex items-center justify-between gap-3 lg:hidden">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="truncate text-[10px] font-semibold uppercase tracking-[0.22em] text-[#6f89a4]">
                  {pageEyebrow}
                </p>
                <p className="truncate text-[1.1rem] font-semibold tracking-[-0.04em] text-[#173b70]">
                  {pageTitle}
                </p>
              </div>
            </div>
            ...
            {profileImage ? (
              ...
              <div className="flex h-10 w-10 items-center justify-center rounded-full border border-[#c1cfdb] bg-[linear-gradient(180deg,#dde8f2_0%,#ccd9e7_100%)] text-[13px] font-bold text-[#2c6d9f] shadow-[0_8px_18px_rgba(59,83,112,0.08)]">
          ...
          <div className="hidden lg:block">
            ...
            <h1 className="mt-1 text-[1.32rem] font-semibold tracking-[-0.04em] text-[#173b70]">
              {pageTitle}
            </h1>
          </div>
        </div>
        ...
        <div className="hidden items-center gap-3 lg:flex">
          <div className="flex items-center gap-2 rounded-full border border-[#c1cfdb] bg-[rgba(250,252,253,0.96)] px-4 py-2 shadow-[0_8px_20px_rgba(59,83,112,0.08)]">
            ...
            <span className="text-[13px] text-[#6c859f]">Search faculty tools</span>
          </div>
          <button
            type="button"
          ...
          >
            ...
            <span className="absolute right-0.5 top-0.5 flex h-4 w-4 items-center justify-center rounded-full bg-[#ff8a7a] text-[10px] font-bold text-white">
              2
            </span>
          </button>
          <div className="flex items-center gap-3 rounded-full border border-[#c1cfdb] bg-[rgba(250,252,253,0.96)] px-2.5 py-2 shadow-[0_8px_20px_rgba(59,83,112,0.08)] sm:px-3">
            {profileImage ? (
              ...
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[linear-gradient(180deg,#dde8f2_0%,#ccd9e7_100%)] text-[13px] font-bold text-[#2c6d9f]">
                {firstName.slice(0, 1).toUpperCase()}
              </div>
            )}
            <div className="hidden md:block">
              <p className="text-sm font-semibold text-[#123b74]">{firstName}</p>
              <p className="text-[12px] text-[#6c859f]">{department}</p>
            </div>
          </div>
        </div>
      </div>
