      ...
      <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
        <div className="min-w-0">
          <div className="flex items-center justify-between gap-3 lg:hidden">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="text-[10px] font-semibold uppercase tracking-[0.26em] text-[#2b79ba]">
                Student workspace
                </p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              ...
              {profileImage ? (
                ...
                <div className="flex h-10 w-10 items-center justify-center rounded-full border border-[#b2c3d4] bg-[linear-gradient(180deg,#d9e7f5_0%,#c6d9ed_100%)] text-[13px] font-bold text-[#2b79ba] shadow-[0_8px_18px_rgba(59,83,112,0.08)]">
        ...
        <div className="hidden flex-wrap items-center gap-3 lg:flex lg:justify-end">
          <div className="hidden items-center gap-2 rounded-full border border-[#b8c8d8] bg-[rgba(245,249,252,0.92)] px-4 py-2 shadow-[0_8px_20px_rgba(59,83,112,0.08)] sm:flex">
            ...
            <span className="text-[13px] text-[#69829e]">Search portal</span>
          </div>
          <button
            type="button"
          ...
          <div className="flex items-center gap-3 rounded-full border border-[#b8c8d8] bg-[rgba(245,249,252,0.92)] px-2.5 py-2 shadow-[0_8px_20px_rgba(59,83,112,0.08)] sm:px-3">
            {profileImage ? (
              ...
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[linear-gradient(180deg,#cadcf0_0%,#bacfe6_100%)] text-[13px] font-bold text-[#2b79ba]">
                {firstName.slice(0, 1).toUpperCase()}
              </div>
            )}
            <div className="hidden md:block">
              <p className="text-sm font-semibold text-[#123b74]">{firstName}</p>
              <p className="text-[12px] text-[#69829e]">{section}</p>
            </div>
          </div>
        </div>
      </div>
