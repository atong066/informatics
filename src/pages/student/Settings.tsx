      ...
      <div className="grid gap-5 px-4 py-5 sm:px-7 lg:px-8">
        <section className="rounded-[2rem] border border-[#b8cddd] bg-[linear-gradient(120deg,#eef4f9_0%,#e4edf5_38%,#dde7f0_100%)] px-5 py-6 shadow-[0_18px_34px_rgba(49,70,98,0.1)] sm:px-6">
          <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_260px] lg:items-start">
            ...
            <div className="rounded-[1.7rem] bg-[linear-gradient(180deg,#365678_0%,#284463_100%)] px-5 py-5 text-white shadow-[0_20px_32px_rgba(27,46,70,0.2)]">
              <p className="text-[12px] text-[#d2dfec]">Account security</p>
              <p className="mt-3 text-[1.35rem] font-semibold leading-tight">{activeUser.email}</p>
              <p className="mt-2 text-[14px] text-[#e8eff6]">@{activeUser.username}</p>
              <p className="mt-4 text-[14px] text-[#d2dfec]">Password can be changed below.</p>
            </div>
          </div>
        </section>
        ...
        <section className="rounded-[1.9rem] border border-[#bfcedd] bg-[linear-gradient(180deg,#f3f7fb_0%,#edf3f8_100%)] p-5 shadow-[0_16px_30px_rgba(49,70,98,0.08)] sm:p-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[1.12rem] font-semibold text-[#123b74]">Change password</p>
          ...
          <div className="mt-6 grid gap-4 md:max-w-xl">
            ...
            <div className="pt-2">
              <button
                ...
                className="rounded-full bg-[linear-gradient(180deg,#2b79ba_0%,#235f97_100%)] px-5 py-3 text-[14px] font-semibold text-white shadow-[0_10px_20px_rgba(27,46,70,0.18)] transition hover:scale-[1.01] disabled:cursor-not-allowed disabled:opacity-70"
              >
...
function Field({
  ...
  return (
    <label className="grid gap-2">
      <span className="text-[13px] font-semibold text-[#244d7f]">{label}</span>
      <input
        type={type}
        value={value}
