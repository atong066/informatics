...
function AdminFaculty() {
  ...
  const [isFacultyAccountModalOpen, setIsFacultyAccountModalOpen] = useState(false);
  ...
  function resetFacultyForm() {
    setIsFacultyAccountModalOpen(false);
  ...
  function openCreateFacultyModal() {
    ...
    setFacultyForm(emptyFacultyAccountForm());
    setFacultyFieldErrors({});
    setIsFacultyAccountModalOpen(true);
  }
  ...
  return (
    ...
    >
      ...
      <Modal
        open={isFacultyAccountModalOpen}
        title={editingFacultyId ? 'Edit faculty account' : 'Add faculty account'}
        description={editingFacultyId
          ...
          <>
            ...
            >
              ...
              {saveFacultyMutation.isPending
                ? 'Saving...'
                : editingFacultyId ? 'Save changes' : 'Create account'}
            </button>
          </>
        )}
      >
      ...
      <div className="mx-auto flex min-h-[calc(100dvh-0.88rem)] w-full max-w-none flex-col px-4 py-5 sm:px-6 lg:min-h-[calc(100dvh-1.04rem)] lg:px-8">
        <section className="hidden overflow-hidden rounded-[0.288rem] border border-[#c9d7db] bg-[linear-gradient(135deg,rgba(251,254,254,0.97)_0%,rgba(238,245,246,0.95)_100%)] px-5 py-4 shadow-[0_16px_30px_rgba(54,79,92,0.07)] sm:px-6 sm:py-5">
        ...
        <div className="hidden mt-5 rounded-[0.272rem] border border-[#c9d7db] bg-[rgba(251,254,254,0.92)] p-5 shadow-[0_14px_28px_rgba(54,79,92,0.06)]">
            ...
            <div className="lg:col-span-3">
              <InputField label="Address" error={facultyFieldErrors.address}>
                <textarea
                  ...
                  className="admin-text-input rounded-[0.192rem]"
                />
              </InputField>
            </div>
          </div>
          ...
          <div className="mt-5 flex flex-col gap-3 sm:flex-row">
            <button
              ...
              onClick={handleFacultySubmit}
              disabled={saveFacultyMutation.isPending}
              className="inline-flex items-center justify-center gap-2 rounded-[0.16rem] border border-[#1f8a78] bg-[linear-gradient(180deg,#27a18f_0%,#1a7b6f_100%)] px-4 py-3 text-fluid-base font-semibold text-white transition hover:brightness-105 disabled:cursor-not-allowed disabled:opacity-60"
            >
              <FiUserCheck className="h-4 w-4" />
              {saveFacultyMutation.isPending
                ? 'Saving...'
            ...
            <button
              type="button"
              onClick={resetFacultyForm}
              className="inline-flex items-center justify-center gap-2 rounded-[0.16rem] border border-[#d1dde1] bg-white px-4 py-3 text-fluid-base font-semibold text-[#52707d] transition hover:bg-[#f8fbfb]"
            >
        ...
        <section className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-[0.272rem] border border-[#c9d7db] bg-[rgba(251,254,254,0.92)] p-4 shadow-[0_14px_28px_rgba(54,79,92,0.06)] sm:p-5">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
              <span className="inline-flex items-center gap-2 whitespace-nowrap rounded-full border border-[#d1dde1] bg-white px-3 py-2 text-fluid-sm font-semibold text-[#52707d]">
                <FiUsers className="h-4 w-4" />
                {facultyUsers.length} faculty
              </span>
              <button
              ...
              <label className="flex min-w-0 items-center gap-3 rounded-[0.168rem] border border-[#c9d7db] bg-white px-4 py-2.5 text-[#6f8d99] sm:w-[4rem]">
          ...
          <div className="mt-5 min-h-0 flex-1 overflow-hidden rounded-[0.232rem] border border-[#d7e2e6] bg-[linear-gradient(180deg,rgba(255,255,255,0.96)_0%,rgba(244,249,250,0.96)_100%)]">
            <div className="scrollbar-super-thin h-full overflow-auto">
              <table className="w-full min-w-[920px] table-fixed border-separate border-spacing-0">
                <thead>
                  <tr>
                    <TableHeadCell className="w-[25%] rounded-tl-[0.232rem]">Faculty</TableHeadCell>
                    ...
                    <TableHeadCell className="w-[12%] rounded-tr-[0.232rem] text-right">Actions</TableHeadCell>
                  </tr>
                </thead>
                <tbody>
      ...
      >
        {viewedFaculty ? (
          <div className="space-y-5">
            ...
            <section className="rounded-[0.216rem] border border-[#c9d7db] bg-[rgba(251,254,254,0.92)] p-4">
              ...
              <div className="mt-4 grid gap-3 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)_auto] lg:items-end">
                ...
                <button
                  ...
                  className="inline-flex h-[0.512rem] items-center justify-center gap-2 rounded-[0.16rem] border border-[#1f8a78] bg-[linear-gradient(180deg,#27a18f_0%,#1a7b6f_100%)] px-5 text-fluid-base font-semibold text-white transition hover:brightness-105 disabled:cursor-not-allowed disabled:opacity-60"
                >
            ...
            <section className="rounded-[0.216rem] border border-[#c9d7db] bg-[rgba(251,254,254,0.92)] p-4">
              ...
              <div className="mt-4 overflow-hidden rounded-[0.2rem] border border-[#d7e2e6] bg-white">
                <div className="overflow-x-auto">
                  <table className="w-full min-w-[760px] table-fixed border-separate border-spacing-0">
                    <thead>
                      <tr>
                        <TableHeadCell className="w-[24%] rounded-tl-[0.2rem]">Subject</TableHeadCell>
                        ...
                        <TableHeadCell className="w-[8%] rounded-tr-[0.2rem] text-right">Remove</TableHeadCell>
                      </tr>
                    </thead>
                    <tbody>
                          ...
                          >
                            ...
                            <td className="border-b border-[#dce6e9] px-4 py-4 align-top text-right">
                              <button
                                ...
                                disabled={saveAssignmentMutation.isPending}
                                className="inline-flex h-10 w-10 items-center justify-center rounded-[0.152rem] border border-[#ecd6d6] bg-[#fff7f7] text-[#a95f5f] transition hover:bg-[#fff1f1] disabled:cursor-not-allowed disabled:opacity-60"
...
function DetailCard({
  ...
  return (
    <div className="rounded-[0.176rem] border border-[#c9d7db] bg-[rgba(251,254,254,0.92)] px-4 py-4">
